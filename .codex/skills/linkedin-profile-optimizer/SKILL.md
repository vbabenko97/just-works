...
## Fact and Consent Safety

Use only claims supported by the user's supplied material or explicit statements. Never invent skills, metrics, dates, titles, ownership, or outcomes. Treat platform limits, algorithm claims, visibility multipliers, and posting-frequency advice as changeable guidance that must be verified before presenting it as current fact. Do not change public visibility, Open to Work, contact details, or profile media without explicit user approval.
...
**Impact:** A suitable photo may help profile recognition. Do not quote a visibility multiplier without a current primary source.
...
**Strategy:**
- Add only relevant, evidenced skills; verify LinkedIn's current limit before quoting one
...
- Use target-role terminology naturally where it accurately describes the user
- Treat ranking and reach mechanisms as undocumented and changeable
- Do not make keyword-density, activity, or completeness guarantees

## Profile Completeness Checklist

**Profile completeness review (verify current LinkedIn UI and requirements):**
- ✅ Professional photo
...
**Optional additions when relevant and supported:**
...
### Posting Frequency:
- Choose a sustainable cadence only if content creation serves the user's goal
- Do not present a universal minimum or optimal frequency without current evidence
